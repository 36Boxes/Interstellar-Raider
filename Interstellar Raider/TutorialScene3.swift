...
class TutorialScene3: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        TutorialHelp.text = "Run into coins to get power-ups"
        ...
        TutorialHelp1.text = "The purple coin offers double points"
        ...
        TutorialHelp2.text = "The background will turn green while it is active"
